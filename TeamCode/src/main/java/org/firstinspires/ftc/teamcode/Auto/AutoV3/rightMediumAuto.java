...
public class rightMediumAuto extends LinearOpMode {
    ...
    public static double toPoleLineH = 13;
    public static double toPoleBackAgain = 1;

    public static double parkCenterLineX = 35;
    public static double parkCenterLineY = -13.5;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence toPole = drive.trajectorySequenceBuilder(startPose)
                .back(toPoleBack)
                .turn(Math.toRadians(90 + toPoleLineH))
                .back(toPoleBackAgain)
                .build();
        ...
        TrajectorySequence parkLeft = drive.trajectorySequenceBuilder(toPole.end())
                ...
                .lineToLinearHeading(new Pose2d(parkCenterLineX - parkLeftMove + 3, parkCenterLineY, Math.toRadians(parkLeftTurn)))
                .build();
        ...
        TrajectorySequence parkRight = drive.trajectorySequenceBuilder(toPole.end())
                ...
                .setTurnConstraint(40, 40)
                .lineToLinearHeading(new Pose2d(parkCenterLineX, parkCenterLineY, Math.toRadians(parkCenterLineH)))
                .lineToLinearHeading(new Pose2d(parkCenterLineX + parkRightMove + 2, parkCenterLineY + 1, Math.toRadians(parkRightTurn)))
                .build();
