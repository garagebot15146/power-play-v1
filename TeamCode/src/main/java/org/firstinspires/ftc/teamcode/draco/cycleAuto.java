package org.firstinspires.ftc.teamcode.draco;//package org.firstinspires.ftc.teamcode.AutoV2;
//
...
//@Disabled
//public class cycleAuto extends OpMode {
//    HWMap drive;
//
//    // CLOCK
...
//                }
//                // Bring intake up
//                if (cycletime.seconds() >= 0.6) {
//                    setExtension(0);
//                    if (extensionPos < 10) {
//                        if (cycletime.seconds() >= 0.9 + cycleDelay) {
//                            intakeUp();
//                            if (cycletime.seconds() >= 1.9 + cycleDelay) {
//                                clawOpen();
//                                if (cycletime.seconds() >= 2.3 + cycleDelay) {
//                                    cycletime.reset();
